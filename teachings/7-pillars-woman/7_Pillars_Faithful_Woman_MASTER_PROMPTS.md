...
YOUTUBE_ID: "XuLetJBP554"            // YouTube video ID for embed on landing page
PODCAST_FEED_URL: ""                  // Podcast RSS feed URL (Spotify, Apple, etc.)
PODCAST_EPISODE_URL: ""              // Direct link to this episode (for card on landing page)
PILLAR_COUNT: 7
...
## Current week's package — what's built and deployed

### Live URLs
- **Landing page:** https://staytheway.com/teachings/7-pillars-woman/
- **Bible Bingo:** https://staytheway.com/teachings/7-pillars-woman/bingo.html
- **Teaching Quiz:** https://staytheway.com/teachings/7-pillars-woman/quiz.html
- **Prayer Request:** https://staytheway.com/teachings/7-pillars-woman/prayer.html
- **Kids Bingo:** https://staytheway.com/teachings/7-pillars-woman/kids-bingo.html
- **Kids Quiz:** https://staytheway.com/teachings/7-pillars-woman/kids-quiz.html
- **Kids Activity:** https://staytheway.com/teachings/7-pillars-woman/kids-activity.html
- **YouTube:** https://youtu.be/XuLetJBP554

### Slide deck (12 slides, vertical 9:16)
1. Title — key verse John 10:27
2. **Bible Bingo invite + QR** → staytheway.com/teachings/7-pillars-woman/bingo.html
3–9. Pillars 1–7 (Eve, Michal, Jezebel, Sapphira, Job's wife, Delilah, Lot's wife)
10. Wrap-Up — John 10:27–28
11. **Prayer Request invite + QR** → staytheway.com/teachings/7-pillars-woman/prayer.html
12. **Take the Quiz invite + QR** → staytheway.com/teachings/7-pillars-woman/quiz.html

### Deployed HTML suite
| File | Purpose |
|------|---------|
| `index.html` | Landing page with YouTube embed + card links to all resources |
| `bingo.html` | 5×5 Bible Bingo, 24 terms + My Voice free space |
| `quiz.html` | 8-question quiz, instant feedback, final score |
| `prayer.html` | Prayer form + honeypot + double opt-in (no-cors fetch to Apps Script) |
| `verified.html` | Thank-you page after prayer verification (calls Apps Script in background) |
| `kids-bingo.html` | 4×4 kids bingo with emoji icons |
| `kids-quiz.html` | 5-question kids quiz with fun feedback |
| `kids-activity.html` | Color pillars + trace verse + draw prayer |
| `apps-script.gs` | Apps Script backend (prayer + email list + 24hr follow-up) |
| `README.md` | Deployment notes |

### Backend
- **Google Sheet:** "StayTheWay Prayer + Email List" (ID: `17fQurx9slXJVayFWF4RYC9VuDz3lTibyoMSJp9VcsHQ`)
- **Apps Script:** "staythewayprayer" — prayer submission, verification, notifications to info@staytheway.com
- **24hr follow-up:** Hourly trigger sends a follow-up email asking how to keep praying
- **Email list:** Opt-in subscribers collected alongside prayer requests
...
# Upload ALL files from local machine
...
Add TWO rules inside the `# BEGIN StayTheWay Teachings Rewrite` block in `/public_html/.htaccess`:
```
RewriteRule ^teachings/{TEACHING_SLUG}/$ /stw-teachings/{TEACHING_SLUG}/index.html [L]
RewriteRule ^teachings/{TEACHING_SLUG}/(.*)$ /stw-teachings/{TEACHING_SLUG}/$1 [L]
```
The first rule maps the directory URL to index.html. The second catches all files.
